...
- (void)addEffectsFromDirectory:(NSString *)directory
{
    ...
    [self.objectivec addObject:[[CLEffect alloc] initWithName:@"Page Flip" selectorName:@"pageFlip" developer:@"Ryan Nair"]];
    ...
    [self.effects addObject:[[CLEffect alloc] initWithName:@"Snake" selectorName:@"snake" developer:@"Ryan Nair"]];
